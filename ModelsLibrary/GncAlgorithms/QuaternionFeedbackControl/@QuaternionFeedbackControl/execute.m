function [desired_torque_B_B__N_m, ...
            error_quaternion_RB, ...
...
%
%   Outputs:
%   desired_torque_B_B__N_m: 3x1 vector of desired torque in body frame
...
desired_torque_B_B__N_m = Kp * sign(error_quaternion_RB(1)) * error_quaternion_RB(2:4) + Kd * angular_velocity_error_RB_B; 
